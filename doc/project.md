...
`org.yx.core`定义litemall-core模块的日志级别
`org.yx.db`定义litemall-core模块的日志级别
`org.yx.wx`定义litemall-wx-api模块的日志级别
`org.yx.admin`定义litemall-admin-api模块的日志级别
`org.yx`而定义litemall所有后端模块的日志级别
