...
```
org.apache.ibatis.binding.BindingException: Invalid bound statement (not found): org.yx.db.dao.XXXX
```
...
The error may exist in org/yx/litemall/db/dao/LitemallSystemMapper.xml
The error may involve org.yx.db.dao.LitemallSystemMapper.selectByExample-Inline
