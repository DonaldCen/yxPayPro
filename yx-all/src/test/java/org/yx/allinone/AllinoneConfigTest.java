...
//        System.out.println(environment.getProperty(""));
        ...
        System.out.println(environment.getProperty("logging.level.org.yx.wx"));
        System.out.println(environment.getProperty("logging.level.org.yx.admin"));
        System.out.println(environment.getProperty("logging.level.org.yx"));
    }
